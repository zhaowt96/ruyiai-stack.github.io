...
For more information, please see our [documents](https://github.com/buddy-compiler/buddy-mlir/tree/main/docs) and [open projects](https://github.com/buddy-compiler/buddy-compiler.github.io/blob/main/Pages/OpenProjects.md).
...
![overview](./assets/compiler-overview.png)
